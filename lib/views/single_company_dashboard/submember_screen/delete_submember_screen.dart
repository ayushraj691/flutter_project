...
class DeleteSubmemberScreen extends StatefulWidget {
  const DeleteSubmemberScreen({super.key});

  @override
  State<DeleteSubmemberScreen> createState() => _DeleteSubmemberScreenState();
}

class _DeleteSubmemberScreenState extends State<DeleteSubmemberScreen> {
  TextEditingController searchController = TextEditingController();
  var deleteSubmemberTabController = Get.find<DeleteSubmemberController>();
  ...
  void CallMethod() async{
    await deleteSubmemberTabController.getDeleteSubmember(
    ...
    filteredItems = deleteSubmemberTabController.deleteSubmemberList;
  }
                  ...
                  Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(() {
                          if (deleteSubmemberTabController
                              .deleteSubmemberList.isEmpty) {
