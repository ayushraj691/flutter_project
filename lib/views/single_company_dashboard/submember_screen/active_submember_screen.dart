...
class ActiveSubmemberScreen extends StatefulWidget {
  const ActiveSubmemberScreen({super.key});

  @override
  State<ActiveSubmemberScreen> createState() => _ActiveSubmemberScreenState();
}

class _ActiveSubmemberScreenState extends State<ActiveSubmemberScreen> {
  TextEditingController searchController = TextEditingController();
  var activeSubmemberTabController = Get.find<ActiveSubmemberController>();
  ...
  void CallMethod() async{
    ...
    filteredItems = activeSubmemberTabController.activeSubmemberList;
  }
                  ...
                  Card(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(() {
                          if (activeSubmemberTabController
