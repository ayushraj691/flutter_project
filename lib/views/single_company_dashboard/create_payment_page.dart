...
class _CreatePaymentPageState extends State<CreatePaymentPage> {
  ...
  void initState() {
    ...
    createPaymentController.filteredCustomers = createPaymentController.customerList;
  }

  void callMethods() async{
    await createPaymentController.getCustomerList(CommonVariable.businessId.value);
    await createPaymentController.getProductList(CommonVariable.businessId.value);
  }
  ...
  void filterProductSearchResults(String query) {
    setState(() {
      createPaymentController.filteredProduct = createPaymentController.productList
          .where((product) =>
  ...
  void selectProduct(String productName, RxInt index,String proId) {
    ...
    this.createPaymentController.selectedProduct = productName;
    createPaymentController.productPricingTextController.value.text = selectedPrice.toString();
  ...
  void calculateTotalAmount() {
    double quantity = double.tryParse(createPaymentController.productQuantityTextController.value.text) ?? 0.0;
    double price = double.tryParse(createPaymentController.productPricingTextController.value.text) ?? 0.0;
                            ...
                            child: Column(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          createPaymentController.isDropdownOpen = !createPaymentController.isDropdownOpen;
                                        });
                                      },
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(createPaymentController.selectedCustomer, style: const TextStyle(fontSize: 16)),
                                            Icon(createPaymentController.isDropdownOpen ? Icons.arrow_drop_up : Icons.arrow_drop_down),
                                          ],
                                        ),
                                      ),
                                    ),
                                    if (createPaymentController.isDropdownOpen)
                                      Container(
                                        ...
                                        child: Column(
                                          children: [
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        boxShadow: [
                                                          BoxShadow(
                                                            ...
                                                            offset: const Offset(0, 0), // Position of shadow (x, y)
                                                          ),
                                                        ],
                                                      ...
                                                      child: TextField(
                                                        controller: createPaymentController.searchController,
                                                        onChanged: (value) => filterSearchResults(value),
                                                        maxLines: 1, // Ensures single-line input with horizontal scrolling
                                                        textAlignVertical: TextAlignVertical.center, // Centers text vertically within TextField
                                                        decoration: const InputDecoration(
                                                          isDense: true, // Helps align the content within the fixed height
                                                          contentPadding: EdgeInsets.symmetric(
                                                            vertical: 8.0, // Fine-tune vertical padding for alignment
                                                            horizontal: 12.0, // Space for horizontal padding
                                                          ),
                                                  ...
                                                  Container(
                                                    ...
                                                    child: ElevatedButton.icon(
                                                      ...
                                                      label: const Text("Create",style: TextStyle(
                                                        fontFamily: 'Sofia Sans',
                                                        fontSize: 14.0,
                                                        fontWeight: FontWeight.w400,
                                                        color: Colors.white,
                                            ...
                                            Expanded(
                                              child: SingleChildScrollView(
                                                child: Column(
                                                  children: createPaymentController.filteredCustomers.asMap().entries.map((entry) {
                                                    int index = entry.key;
                                                    var customer = entry.value;
                                                    return GestureDetector(
                                                      onTap: () => {
                                                        selectCustomer(customer.info.custName,index,customer.sId),
                                                        customerDetailViewController.getSingleData(customer.sId),
                                                        createPaymentController.isVisibilityAccount.value = true,
                                                      },
                                                      child: CustomerTile(
                                ...
                                CommonTextField(
                                  ...
                                  focusNode:
                                      createPaymentController.checkNoFocusNode,
                                  inputFormatters: [
                                  ...
                                  onChanged: (value) {
                                    ...
                                    setState(() {
                                      if (value.isEmpty) {
                                        createPaymentController.checkNoValid = false.obs;
                                      } else if (regExp.hasMatch(value)) {
                                        createPaymentController.checkNoValid = true.obs;
                                        createPaymentController.checkNoErrorMessage = "check No Must be 4 digit";
                                      } else {
                                        createPaymentController.checkNoValid = false.obs;
                                      }
                                    });
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: UnderlineInputBorder(
                                      borderSide: BorderSide(
                                        color: createPaymentController.checkNoValid.value
                                    ...
                                    errorText: createPaymentController.checkNoValid.value
                                        ? null
                                        : 'CheckNo is required',
                                ...
                                CommonTextField(
                                  ...
                                  focusNode: createPaymentController.memoFocusNode,
                                  inputFormatters: [
                                  ...
                                  onChanged: (value) {
                                    ...
                                    setState(() {
                                      if (value.isEmpty) {
                                        createPaymentController.memoValid = false.obs;
                                      } else if (regExp.hasMatch(value)) {
                                        createPaymentController.memoValid = true.obs;
                                      } else {
                                        createPaymentController.memoValid = false.obs;
                                      }
                                    });
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: UnderlineInputBorder(
                                      borderSide: BorderSide(
                                        color: createPaymentController.memoValid.value
                                            ? AppColors.appNeutralColor5
                                            : AppColors.appRedColor,
                                        width: 1, // Thickness for the underline
                                      ),
                                    ...
                                    errorText: createPaymentController.memoValid.value
                                        ? null
                                        : 'Memo is required',
                                    // Error message when invalid
                                    hintText: "Enter Memo",
                                  ...
                                  if (customerDetailViewController.allBankList.isEmpty) {
                                    ...
                                    return  ListView.builder(
                                      ...
                                      itemCount: (customerDetailViewController.allBankList.isNotEmpty &&
                                          createPaymentController.selectedCustomer != "Select Customer")
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: (){
                                ...
                                setState(() {
                                  createPaymentController.productQuantityTextController.value = TextEditingController(text: "1");
                                  createPaymentController.isDropdownOpen = false;
                                });
                              },
                              child: const Row(
                    ...
                    child: Column(
                      children: [
                        Obx(() {
                          return ListView.builder(
                            shrinkWrap: true,
                            itemCount: createPaymentController.addProductList.length,
                            itemBuilder: (context, index) {
                              return ProductListItem(
                                quantity: createPaymentController.addProductList[index].qantity,
                                price: createPaymentController.addProductList[index].price,
                                productName: createPaymentController.addProductList[index].productName,
                                totalPrice: createPaymentController.addProductList[index].totalPrice,
                              );
                            },
                            physics: const ScrollPhysics(),
                          );
          ...
          Padding(
            ...
            child: Center(
              child: CommonButton(
                ...
                buttonName: "Submit",
                onPressed: () {
                  if (createPaymentController.selectedCustomer != "Select Customer") {
                    if(createPaymentController.customerValidation(context)){
                      createPaymentController.productDetailList();
                      if(createPaymentController.finalProductList.isNotEmpty){
                        GeneralMethods.loadingDialog(context);
                      createPaymentController.insertCustomerPaymentData();}else{
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? AppColors.appBlueLightColor : AppColors.appNeutralColor5,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                GeneralMethods.maskAccountNumber(allBusinessList[index].accountNumber),
                                style: TextStyle(
                                  color: AppColors.appBlackColor,
                                  fontSize: 16,
                                  fontFamily: Constants.Sofiafontfamily,
  ...
  void itemParticularPopup(BuildContext context) {
    createPaymentController.filteredProduct.assignAll(createPaymentController.productList);
                  ...
                  Column(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            createPaymentController.isProductDropdownOpen.value = !createPaymentController.isProductDropdownOpen.value;
                          });
                        },
                        child: Obx(() => Container(
                          padding: const EdgeInsets.only(
                              right: 16.0, left: 16.0, top: 12.0, bottom: 12.0),
                          decoration: BoxDecoration(
                            color: AppColors.appNeutralColor5,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(createPaymentController.selectedProduct, style: const TextStyle(fontSize: 16)),
                              Icon(createPaymentController.isProductDropdownOpen.value
                                  ? Icons.arrow_drop_up
                      ...
                      Obx(() {
                        if (createPaymentController.isProductDropdownOpen.value) {
                          return Container(
                            margin: const EdgeInsets.only(top: 10),
                            padding: const EdgeInsets.all(10),
                            decoration: BoxDecoration(
                            ...
                            child: Column(
                              children: [
                                    ...
                                    children: [
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: TextField(
                                            controller: createPaymentController.productSearchController,
                                            onChanged: (value) =>
                                                filterProductSearchResults(value),
                                            maxLines: 1,
                                ...
                                Expanded(
                                  child: SingleChildScrollView(
                                    child: Column(
                                      children: createPaymentController.filteredProduct.asMap().entries.map((entry) {
                                        ...
                                        return GestureDetector(
                                          onTap: () => selectProduct(proName.value, index,proId.value),
                                          child: ProductTile(
                    ...
                    children: [
                      Expanded(
                        child: CommonTextField(
                          hintText: 'Quantity',
                          controller: createPaymentController.productQuantityTextController.value,
                          labelText: 'Quantity',
                          keyboardType: TextInputType.number,
                      ...
                      Expanded(
                        child: CommonTextField(
                          hintText: 'Pricing',
                          controller: createPaymentController.productPricingTextController.value,
                          keyboardType: TextInputType.number,
                          inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                          labelText: 'Pricing',
                          onChanged: (value) {
                  ...
                  Center(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if(createPaymentController.selectedProduct=="Select Product"){
                           MyToast.toast("Please Select product");
                          }else if (createPaymentController.productQuantityTextController.value.text.isEmpty){
                            MyToast.toast("Please Select Quantity");
                          }else if (createPaymentController.productPricingTextController.value.text.isEmpty){
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(productId, style: const TextStyle(fontSize: 12, color: Colors.grey)),
                  ],
                ),
              ],
            ),
