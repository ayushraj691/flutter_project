...
class SubscriptionTransactionsDetails extends StatefulWidget {
  ...
  const SubscriptionTransactionsDetails({super.key, required this.id});

  @override
  State<SubscriptionTransactionsDetails> createState() =>
      _SubscriptionTransactionsDetailsState();
}

class _SubscriptionTransactionsDetailsState
    extends State<SubscriptionTransactionsDetails> {
