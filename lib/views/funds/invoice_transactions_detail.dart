...
class InvoiceTransactionsDetails extends StatefulWidget {
  ...
  @override
  State<InvoiceTransactionsDetails> createState() =>
      _InvoiceTransactionsDetailsState();
}

class _InvoiceTransactionsDetailsState
    extends State<InvoiceTransactionsDetails> {
  ...
  Widget _buildPurchaseDetailsCard(
      List<ProDetail> allproductList, int index, context) {
    return Padding(
      padding: const EdgeInsets.only(left: 16.0,right: 16.0,bottom: 4.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Align(
                ...
                child: Obx(() =>
                    Container(
                      ...
                      child: Obx(() =>
                          Text(itemTransactionController.isSchedule == true &&
                              itemTransactionController.payMode == '0'
                              ? 'Scheduler'
                              : (
                              itemTransactionController.isDeleted == false &&
                                  ...
                                  : 'Unknown'))))))))))),
                            style: TextStyle(
                                color: itemTransactionController.isSchedule ==
                                    true &&
                                    itemTransactionController.payMode == '0'
                                    ? AppColors.appYellowColor
                                    : (itemTransactionController.isDeleted ==
