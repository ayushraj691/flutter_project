...
class _SuccessfullScreenState extends State<SuccessfullScreen> {
  ...
  var successfulFundsTabController = Get.find<SuccessfulFundsController>();
  ...
  void callMethod() async{
    await successfulFundsTabController.getSuccessfulFundsData(
      ...
      successfulFundsTabController.startDate.value,
      successfulFundsTabController.endDate.value,
      jsonEncode(sortMap),
    );
    filteredItems = successfulFundsTabController.successfulFundsList;
  }
