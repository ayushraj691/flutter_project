...
class _SubscriptionsNewTabState extends State<SubscriptionsNewTab> {
  ...
  void toggleSelectionMode(int index,String id) {
    setState(() {
      if (newSubscriptionsTabController.isSelectionMode) {
        ...
        if (newSubscriptionsTabController.selectedItems.length == filteredItems.length) {
        ...
        newSubscriptionsTabController.selectedItems.add(index);
        newSubscriptionsTabController.selectedIdList.add(id);
        newSubscriptionsTabController.isAllSelected = newSubscriptionsTabController.selectedItems.length == filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (newSubscriptionsTabController.isAllSelected) {
        ...
        newSubscriptionsTabController.selectedItems = List.generate(filteredItems.length, (index) => index);
        newSubscriptionsTabController.selectedIdList = List.generate(filteredItems.length, (id) => id.toString());
      }
      newSubscriptionsTabController.isAllSelected = !newSubscriptionsTabController.isAllSelected;
    });
  }

  void deleteSelectedItems() {
    setState(() {
      newSubscriptionsTabController.deleteData(newSubscriptionsTabController.selectedIdList);
      callMethod();
      newSubscriptionsTabController.selectedItems.clear();
      newSubscriptionsTabController.selectedIdList.clear();
      newSubscriptionsTabController.isSelectionMode = false;
  ...
  void downloadSelectedItems() {
    setState(() {
      newSubscriptionsTabController.downloadData(newSubscriptionsTabController.selectedIdList);
      callMethod();
      newSubscriptionsTabController.selectedItems.clear();
      newSubscriptionsTabController.selectedIdList.clear();
      newSubscriptionsTabController.isSelectionMode = false;
  ...
  void verifySelectedItems() {
    setState(() {
      newSubscriptionsTabController.verifyData(newSubscriptionsTabController.selectedIdList);
      callMethod();
      newSubscriptionsTabController.selectedItems.clear();
      newSubscriptionsTabController.selectedIdList.clear();
      newSubscriptionsTabController.isSelectionMode = false;
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => newSubscriptionsTabController
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text("${newSubscriptionsTabController.selectedItems.length} items selected"),
                                          ],
                                        ),
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              Checkbox(
                                                ...
                                                value: newSubscriptionsTabController.isAllSelected,
                                          ...
                                          child: ElevatedButton.icon(
                                            onPressed: () => {
                                              GeneralMethods.showPopup(
                                                  context,
                                                  "verify ${newSubscriptionsTabController.selectedItems.length}",
                                        ...
                                        Expanded(
                                          child: ElevatedButton.icon(
                                            onPressed: () => {
                                              GeneralMethods.showPopup(
                                                  context,
                                                  "delete ${newSubscriptionsTabController.selectedItems.length}",
  ...
  Widget listTransactionCard(
    ...
    final isSelected = newSubscriptionsTabController.selectedItems.contains(index);
