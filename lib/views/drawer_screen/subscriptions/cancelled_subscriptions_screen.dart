...
class SubscriptionsCancelledTab extends StatefulWidget {
  ...
  @override
  State<SubscriptionsCancelledTab> createState() =>
      _SubscriptionsCancelledTabState();
}

class _SubscriptionsCancelledTabState extends State<SubscriptionsCancelledTab> {
  TextEditingController searchController = TextEditingController();
  var cancelSubscriptionsTabController = Get.find<
  ...
  void deleteSelectedItems() {
    setState(() {
      cancelSubscriptionsTabController.cancelSubscriptionsList.removeWhere(
              (transaction) =>
              selectedItems.contains(cancelSubscriptionsTabController
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              cancelSubscriptionsTabController.downloadCSV();
                            },
                            style: ElevatedButton.styleFrom(
