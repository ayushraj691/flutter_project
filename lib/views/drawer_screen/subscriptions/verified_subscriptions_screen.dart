...
class SubscriptionsVerifiedTab extends StatefulWidget {
  ...
  @override
  State<SubscriptionsVerifiedTab> createState() =>
      _SubscriptionsVerifiedTabState();
}

class _SubscriptionsVerifiedTabState extends State<SubscriptionsVerifiedTab> {
  TextEditingController searchController = TextEditingController();
  var verifiedSubscriptionsTabController = Get.find<
      VerifiedSubscriptionsController>();
  ...
  void callMethod() async {
    ...
    filteredItems =
        verifiedSubscriptionsTabController.verifiedSubscriptionsList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      verifiedSubscriptionsTabController.verifiedSubscriptionsList.removeWhere(
              (transaction) =>
              selectedItems.contains(verifiedSubscriptionsTabController
