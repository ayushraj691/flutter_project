...
class SubscriptionsVerifiedTab extends StatefulWidget {
  const SubscriptionsVerifiedTab({super.key});
  @override
  State<SubscriptionsVerifiedTab> createState() => _SubscriptionsVerifiedTabState();
}

class _SubscriptionsVerifiedTabState extends State<SubscriptionsVerifiedTab> {
  TextEditingController searchController = TextEditingController();
  var verifiedSubscriptionsTabController = Get.find<VerifiedSubscriptionsController>();
  ...
  void callMethod() async{
    await verifiedSubscriptionsTabController.getAllSubscriptionsData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      verifiedSubscriptionsTabController.startDate.value,
      verifiedSubscriptionsTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = verifiedSubscriptionsTabController.verifiedSubscriptionsList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      verifiedSubscriptionsTabController.verifiedSubscriptionsList.removeWhere(
              (transaction) => selectedItems.contains(verifiedSubscriptionsTabController
              .verifiedSubscriptionsList
              .indexOf(transaction)));
      selectedItems.clear();
      isSelectionMode = false;
      isAllSelected = false;
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => verifiedSubscriptionsTabController
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Obx(() {
                                      return Text(
                                        verifiedSubscriptionsTabController
                                            .buttonText.value,
                      ...
                      Card(
                        ...
                        child: Column(
                          children: [
                            ...
                            Obx(() {
                              if (verifiedSubscriptionsTabController
                                  .verifiedSubscriptionsList.isEmpty) {
