...
class SubscriptionsDeletedTab extends StatefulWidget {
  const SubscriptionsDeletedTab({super.key});

  @override
  State<SubscriptionsDeletedTab> createState() => _SubscriptionsDeletedTabState();
}

class _SubscriptionsDeletedTabState extends State<SubscriptionsDeletedTab> {
  TextEditingController searchController = TextEditingController();
  var deleteSubscriptionsTabController = Get.find<DeleteSubscriptionsController>();
  ...
  void callMethod() async{
    await deleteSubscriptionsTabController.getAllSubscriptionsData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      deleteSubscriptionsTabController.startDate.value,
      deleteSubscriptionsTabController.endDate.value,
      "$sortMap",
    );
    filteredItems = deleteSubscriptionsTabController.deleteSubscriptionsList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      deleteSubscriptionsTabController.deleteSubscriptionsList.removeWhere(
              (transaction) => selectedItems.contains(deleteSubscriptionsTabController
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => deleteSubscriptionsTabController
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Obx(() {
                                      return Text(
                                        deleteSubscriptionsTabController
                                            .buttonText.value,
                      ...
                      Card(
                        ...
                        child: Column(
                          children: [
                            ...
                            Obx(() {
                              if (deleteSubscriptionsTabController
                                  .deleteSubscriptionsList.isEmpty) {
