...
class SubscriptionsDeletedTab extends StatefulWidget {
  ...
  @override
  State<SubscriptionsDeletedTab> createState() =>
      _SubscriptionsDeletedTabState();
}

class _SubscriptionsDeletedTabState extends State<SubscriptionsDeletedTab> {
  TextEditingController searchController = TextEditingController();
  var deleteSubscriptionsTabController = Get.find<
  ...
  void deleteSelectedItems() {
    setState(() {
      deleteSubscriptionsTabController.deleteSubscriptionsList.removeWhere(
              (transaction) =>
              selectedItems.contains(deleteSubscriptionsTabController
                  ...
                  Expanded(
                    child: Align(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            deleteSubscriptionsTabController.downloadCSV();
                          },
                          style: ElevatedButton.styleFrom(
