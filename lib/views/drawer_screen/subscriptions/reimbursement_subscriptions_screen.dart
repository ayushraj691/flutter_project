...
class SubscriptionsReimbursementTab extends StatefulWidget {
  const SubscriptionsReimbursementTab({super.key});

  @override
  State<SubscriptionsReimbursementTab> createState() =>
      _SubscriptionsReimbursementTabState();
}

class _SubscriptionsReimbursementTabState
    extends State<SubscriptionsReimbursementTab> {
  TextEditingController searchController = TextEditingController();
  var reimbursementSubscriptionsTabController =
      Get.find<ReimbursementSubscriptionsController>();
  ...
  void callMethod() async{
    await reimbursementSubscriptionsTabController.getAllSubscriptionsData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      reimbursementSubscriptionsTabController.startDate.value,
      reimbursementSubscriptionsTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = reimbursementSubscriptionsTabController.reimbursementSubscriptionsList;
  }

  void _filterItems() {
    String query = searchController.text.toLowerCase();
    setState(() {
      filteredItems = reimbursementSubscriptionsTabController
          .reimbursementSubscriptionsList
  ...
  void deleteSelectedItems() {
    setState(() {
      reimbursementSubscriptionsTabController.reimbursementSubscriptionsList
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => reimbursementSubscriptionsTabController
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Obx(() {
                                      return Text(
                                        reimbursementSubscriptionsTabController
                                            .buttonText.value,
                      ...
                      Card(
                        ...
                        child: Column(
                          children: [
                            ...
                            Obx(() {
                              if (reimbursementSubscriptionsTabController
                                  .reimbursementSubscriptionsList.isEmpty) {
