...
class TransactionReimbursementTab extends StatefulWidget {
  const TransactionReimbursementTab({super.key});

  @override
  State<TransactionReimbursementTab> createState() =>
      _TransactionReimbursementTabState();
}

class _TransactionReimbursementTabState
    extends State<TransactionReimbursementTab> {
  TextEditingController searchController = TextEditingController();
  var reimbursementTransactionTabController =
      Get.find<ReimbursementTransactionController>();
  ...
  void CallMethod() async{
    await reimbursementTransactionTabController.getAllTransactionData(
      CommonVariable.businessId.value,
      '',
      "$argumentMap",
      reimbursementTransactionTabController.startDate.value,
      reimbursementTransactionTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = reimbursementTransactionTabController.reimbursementTransactionList;
  }

  void _filterItems() {
    String query = searchController.text.toLowerCase();
    setState(() {
      filteredItems = reimbursementTransactionTabController
          .reimbursementTransactionList
  ...
  void deleteSelectedItems() {
    setState(() {
      reimbursementTransactionTabController.reimbursementTransactionList
    ...
    return Scaffold(
      body: Column(
        children: [
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () => reimbursementTransactionTabController
                        .showDatePickerDialog(context),
                    child: Obx(() {
                      return Text(
                        reimbursementTransactionTabController.buttonText.value,
          ...
          Expanded(
            child: Obx(() {
              if (reimbursementTransactionTabController
                  .reimbursementTransactionList.isEmpty) {
