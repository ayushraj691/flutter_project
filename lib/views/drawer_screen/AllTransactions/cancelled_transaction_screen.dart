...
class _TransactionCancelledTabState extends State<TransactionCancelledTab> {
  ...
  void toggleSelectionMode(int index,String id) {
    setState(() {
      if (isSelectionMode) {
        if (cancelTransactionTabController.selectedItems.contains(index) && cancelTransactionTabController.selectedId.contains(id)) {
        ...
        if (cancelTransactionTabController.selectedItems.length == filteredItems.length) {
          isAllSelected = true;
        } else {
          isAllSelected = false;
        }
        ...
        cancelTransactionTabController.selectedItems.add(index);
        cancelTransactionTabController.selectedId.add(id);
        isAllSelected = cancelTransactionTabController.selectedItems.length == filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (isAllSelected) {
        ...
        cancelTransactionTabController.selectedItems = List.generate(filteredItems.length, (index) => index);
        cancelTransactionTabController.selectedId = List.generate(filteredItems.length, (id) => id.toString());
      }
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => cancelTransactionTabController
                      ...
                      Card(
                        ...
                        child: Column(
                          children: [
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                                "${cancelTransactionTabController.selectedItems.length} items selected"),
                                          ],
                                        ),
                                        Padding(
                                          padding:
                                          ...
                                          child: ElevatedButton.icon(
                                            onPressed: () => {
                                              GeneralMethods.showPopup(
                                                  context,
                                                  "verify ${cancelTransactionTabController.selectedItems.length}",
                                        ...
                                        Expanded(
                                          child: ElevatedButton.icon(
                                            onPressed: () => {
                                              GeneralMethods.showPopup(
                                                  context,
                                                  "delete ${cancelTransactionTabController.selectedItems.length}",
                            ...
                            Obx(() {
                              if (cancelTransactionTabController
                                  .cancelTransactionList.isEmpty) {
  ...
  Widget listTransactionCard(
    ...
    final isSelected = cancelTransactionTabController.selectedItems.contains(index);
