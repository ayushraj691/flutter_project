...
class TransactionCancelledTab extends StatefulWidget {
  ...
  @override
  State<TransactionCancelledTab> createState() => _TransactionCancelledTabState();
}
...
class _TransactionCancelledTabState extends State<TransactionCancelledTab> {
  ...
  void deleteSelectedItems() {
    setState(() {
      cancelTransactionTabController.cancelTransactionList.removeWhere(
              (transaction) => selectedItems.contains(cancelTransactionTabController
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              if (cancelTransactionTabController.cancelTransactionList.isEmpty) {
