...
class TransactionDeletedTab extends StatefulWidget {
  const TransactionDeletedTab({super.key});

  @override
  State<TransactionDeletedTab> createState() => _TransactionDeletedTabState();
}

class _TransactionDeletedTabState extends State<TransactionDeletedTab> {
  TextEditingController searchController = TextEditingController();
  var deleteTransactionTabController = Get.find<DeleteTransactionController>();
  ...
  void callMethod() async {
    await deleteTransactionTabController.getAllTransactionData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      deleteTransactionTabController.startDate.value,
      deleteTransactionTabController.endDate.value,
      "$sortMap",
    );
    filteredItems = deleteTransactionTabController.deleteTransactionList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      deleteTransactionTabController.deleteTransactionList.removeWhere(
          (transaction) => selectedItems.contains(deleteTransactionTabController
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => deleteTransactionTabController
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Obx(() {
                                      return Text(
                                        deleteTransactionTabController
                                            .buttonText.value,
                          ...
                          Expanded(
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    await deleteTransactionTabController.downloadCSV();
                                  },
                                  style: ElevatedButton.styleFrom(
                      ...
                      Card(
                        ...
                        child: Column(
                          children: [
                            ...
                            Obx(() {
                              if (deleteTransactionTabController
                                  .deleteTransactionList.isEmpty) {
