...
class _TransactionNewTabState extends State<TransactionNewTab> {
  ...
  void deleteSelectedItems() {
    setState(() {
      newTransactionTabController.newTransactionList.removeWhere(
          (transaction) => selectedItems.contains(newTransactionTabController
              .newTransactionList
              .indexOf(transaction)));
      selectedItems.clear();
      isSelectionMode = false;
    ...
    return Scaffold(
      body: Column(
        children: [
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Obx(() {
                      return Text(
                        newTransactionTabController.buttonText.value,
          ...
          Expanded(
            child: Obx(() {
              if (newTransactionTabController.newTransactionList.isEmpty) {
