...
class _TransactionNewTabState extends State<TransactionNewTab> {
  ...
  void toggleSelectionMode(int index,String id) {
    setState(() {
      if (newTransactionTabController.isSelectionMode) {
        ...
        if (newTransactionTabController.selectedItems.length == filteredItems.length) {
        ...
        newTransactionTabController.selectedItems.add(index);
        newTransactionTabController.selectedIdList.add(id);
        newTransactionTabController.isAllSelected = newTransactionTabController.selectedItems.length == filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (newTransactionTabController.isAllSelected) {
        ...
        newTransactionTabController.selectedItems = List.generate(filteredItems.length, (index) => index);
        newTransactionTabController.selectedIdList = List.generate(filteredItems.length, (id) => id.toString());
      }
      newTransactionTabController.isAllSelected = !newTransactionTabController.isAllSelected;
    });
  }

  void deleteSelectedItems() {
    setState(() {
      newTransactionTabController.deleteData(newTransactionTabController.selectedIdList);
      callMethod();
      newTransactionTabController.selectedItems.clear();
      newTransactionTabController.selectedIdList.clear();
      newTransactionTabController.isSelectionMode = false;
  ...
  void downloadSelectedItems() {
    setState(() {
      newTransactionTabController.downloadData(newTransactionTabController.selectedIdList);
      callMethod();
      newTransactionTabController.selectedItems.clear();
      newTransactionTabController.selectedIdList.clear();
      newTransactionTabController.isSelectionMode = false;
  ...
  void verifySelectedItems() {
    setState(() {
      newTransactionTabController.verifyData(newTransactionTabController.selectedIdList);
      callMethod();
      newTransactionTabController.selectedItems.clear();
      newTransactionTabController.selectedIdList.clear();
      newTransactionTabController.isSelectionMode = false;
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => newTransactionTabController
                          ...
                          Expanded(
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    await newTransactionTabController.downloadCSV();
                                  },
                                  style: ElevatedButton.styleFrom(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                                "${newTransactionTabController.selectedItems.length} items selected"),
                                          ],
                                        ),
                                        Padding(
                                          padding:
                                          ...
                                          child: Row(
                                            children: [
                                              Checkbox(
                                                ...
                                                value: newTransactionTabController.isAllSelected,
                                                activeColor:
                                          ...
                                          child: ElevatedButton.icon(
                                            onPressed: () => {
                                              GeneralMethods.showPopup(
                                                  context,
                                                  "verify ${newTransactionTabController.selectedItems.length}",
                                        ...
                                        Expanded(
                                          child: ElevatedButton.icon(
                                            onPressed: () => {
                                              GeneralMethods.showPopup(
                                                  context,
                                                  "delete ${newTransactionTabController.selectedItems.length}",
  ...
  Widget listTransactionCard(
    ...
    final isSelected = newTransactionTabController.selectedItems.contains(index);

    return InkWell(
      onLongPress: () {
        toggleSelectionMode(index,newTransactionTabController.newTransactionList[index].sId);
      },
      onTap: () {
        if (newTransactionTabController.isSelectionMode) {
          toggleSelectionMode(index,newTransactionTabController.newTransactionList[index].sId);
