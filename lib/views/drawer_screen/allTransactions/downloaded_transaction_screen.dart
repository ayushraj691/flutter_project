...
class _TransactionDownloadedTabState extends State<TransactionDownloadedTab> {
  ...
  void toggleSelectionMode(int index, String id) {
    setState(() {
      if (downloadTransactionTabController.isSelectionMode) {
        ...
        if (downloadTransactionTabController.selectedItems.length ==
        ...
        downloadTransactionTabController.selectedItems.add(index);
        downloadTransactionTabController.selectedIdList.add(id);
        downloadTransactionTabController.isAllSelected =
            downloadTransactionTabController.selectedItems.length ==
                filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (downloadTransactionTabController.isAllSelected) {
        ...
        downloadTransactionTabController.selectedItems =
            List.generate(filteredItems.length, (index) => index);
        downloadTransactionTabController.selectedIdList =
  ...
  void cancelSelectedItems() {
    setState(() {
      downloadTransactionTabController.cancelData(
          downloadTransactionTabController.selectedIdList);
      callMethod();
      downloadTransactionTabController.selectedItems.clear();
      downloadTransactionTabController.selectedIdList.clear();
  ...
  void downloadSelectedItems() {
    setState(() {
      downloadTransactionTabController.downloadData(
          downloadTransactionTabController.selectedIdList);
      callMethod();
      downloadTransactionTabController.selectedItems.clear();
      downloadTransactionTabController.selectedIdList.clear();
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              await downloadTransactionTabController
                                  .downloadCSV();
                            },
                            style: ElevatedButton.styleFrom(
                                    ...
                                    child: Row(
                                      children: [
                                        Checkbox(
                                          ...
                                          value: downloadTransactionTabController
                                              .isAllSelected,
                                    ...
                                    child: ElevatedButton.icon(
                                      onPressed: () =>
                                      {
                                        GeneralMethods.showPopup(
                                            context,
                                            "Cancel ${downloadTransactionTabController
  ...
  Widget listTransactionCard(List<ResTransactionDetail> allRecentTransaction,
    ...
    final isSelected = downloadTransactionTabController.selectedItems.contains(
        index);
