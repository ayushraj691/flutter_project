...
class _InvoiceDownloadedTabState extends State<InvoiceDownloadedTab> {
  ...
  void toggleSelectionMode(int index, String id) {
    setState(() {
      if (downloadInvoiceTabController.isSelectionMode) {
        ...
        if (downloadInvoiceTabController.selectedItems.length ==
        ...
        downloadInvoiceTabController.selectedItems.add(index);
        downloadInvoiceTabController.selectedIdList.add(id);
        downloadInvoiceTabController.isAllSelected =
            downloadInvoiceTabController.selectedItems.length ==
                filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (downloadInvoiceTabController.isAllSelected) {
        ...
        downloadInvoiceTabController.selectedItems =
            List.generate(filteredItems.length, (index) => index);
        downloadInvoiceTabController.selectedIdList =
  ...
  void cancelSelectedItems() {
    setState(() {
      downloadInvoiceTabController.cancelData(
          downloadInvoiceTabController.selectedIdList);
      callMethod();
      downloadInvoiceTabController.selectedItems.clear();
      downloadInvoiceTabController.selectedIdList.clear();
  ...
  void downloadSelectedItems() {
    setState(() {
      downloadInvoiceTabController.downloadData(
          downloadInvoiceTabController.selectedIdList);
      callMethod();
      downloadInvoiceTabController.selectedItems.clear();
      downloadInvoiceTabController.selectedIdList.clear();
                                            ...
                                            child: Row(
                                              children: [
                                                Checkbox(
                                                  ...
                                                  value: downloadInvoiceTabController
                                                      .isAllSelected,
                                          ...
                                          Expanded(
                                            child: ElevatedButton.icon(
                                              onPressed: () =>
                                              {
                                                GeneralMethods.showPopup(
                                                    context,
                                                    "cancel ${downloadInvoiceTabController
  ...
  Widget listTransactionCard(List<ResTransactionDetail> allRecentTransaction,
    ...
    final isSelected = downloadInvoiceTabController.selectedItems.contains(
        index);
