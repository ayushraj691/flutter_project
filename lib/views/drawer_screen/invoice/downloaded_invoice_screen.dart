...
class InvoiceDownloadedTab extends StatefulWidget {
  const InvoiceDownloadedTab({super.key});

  @override
  State<InvoiceDownloadedTab> createState() => _InvoiceDownloadedTabState();
}

class _InvoiceDownloadedTabState extends State<InvoiceDownloadedTab> {
  TextEditingController searchController = TextEditingController();
  var downloadInvoiceTabController = Get.find<DownloadInvoiceController>();
  ...
  void callMethod() async{
    await downloadInvoiceTabController.getAllInvoiceData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      downloadInvoiceTabController.startDate.value,
      downloadInvoiceTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = downloadInvoiceTabController.downloadInvoiceList;
  }
  void _filterItems() {
  ...
  void toggleSelectionMode(int index,String id) {
    setState(() {
      if (downloadInvoiceTabController.isSelectionMode) {
        if (downloadInvoiceTabController.selectedItems.contains(index)) {
          downloadInvoiceTabController.selectedItems.remove(index);
          downloadInvoiceTabController.selectedIdList.remove(id);
        } else {
          downloadInvoiceTabController.selectedItems.add(index);
          downloadInvoiceTabController.selectedIdList.add(id);
        }
        if (downloadInvoiceTabController.selectedItems.length == filteredItems.length) {
          downloadInvoiceTabController.isAllSelected = true;
        } else {
          downloadInvoiceTabController.isAllSelected = false;
        }
        if (downloadInvoiceTabController.selectedItems.isEmpty) {
          downloadInvoiceTabController.isSelectionMode = false;
        }
      } else {
        downloadInvoiceTabController.isSelectionMode = true;
        downloadInvoiceTabController.selectedItems.add(index);
        downloadInvoiceTabController.selectedIdList.add(id);
        downloadInvoiceTabController.isAllSelected = downloadInvoiceTabController.selectedItems.length == filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (downloadInvoiceTabController.isAllSelected) {
        downloadInvoiceTabController. selectedItems.clear();
        downloadInvoiceTabController.selectedIdList.clear();
      } else {
        downloadInvoiceTabController.selectedItems = List.generate(filteredItems.length, (index) => index);
        downloadInvoiceTabController.selectedIdList = List.generate(filteredItems.length, (id) => id.toString());
      }
      downloadInvoiceTabController.isAllSelected = !downloadInvoiceTabController.isAllSelected;
    });
  }

  void cancelSelectedItems() {
    setState(() {
      downloadInvoiceTabController.cancelData(downloadInvoiceTabController.selectedIdList);
      callMethod();
      downloadInvoiceTabController.selectedItems.clear();
      downloadInvoiceTabController.selectedIdList.clear();
      downloadInvoiceTabController.isSelectionMode = false;
  ...
  void downloadSelectedItems() {
    setState(() {
      downloadInvoiceTabController.downloadData(downloadInvoiceTabController.selectedIdList);
      callMethod();
      downloadInvoiceTabController.selectedItems.clear();
      downloadInvoiceTabController.selectedIdList.clear();
      downloadInvoiceTabController.isSelectionMode = false;
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () => downloadInvoiceTabController
                    ...
                    Card(
                      ...
                      child: Column(
                        children: [
                                ...
                                children: [
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text("${downloadInvoiceTabController.selectedItems.length} items selected"),
                                        ],
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Checkbox(
                                              ...
                                              value: downloadInvoiceTabController.isAllSelected,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      //           context,
                                      //           "verify ${downloadInvoiceTabController.selectedItems.length}",
                                      ...
                                      Expanded(
                                        child: ElevatedButton.icon(
                                          onPressed: () => {
                                            GeneralMethods.showPopup(
                                                context,
                                                "cancel ${downloadInvoiceTabController.selectedItems.length}",
                          ...
                          Obx(() {
                            if (downloadInvoiceTabController
                                .downloadInvoiceList.isEmpty) {
  ...
  Widget listTransactionCard(
    ...
    final isSelected = downloadInvoiceTabController.selectedItems.contains(index);
