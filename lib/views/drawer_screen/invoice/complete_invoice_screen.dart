...
class _InvoiceCompleteTabState extends State<InvoiceCompleteTab> {
  ...
  void toggleSelectionMode(int index,String id) {
    setState(() {
      if (completeInvoiceTabController.isSelectionMode) {
        ...
        if (completeInvoiceTabController.selectedItems.length == filteredItems.length) {
        ...
        completeInvoiceTabController.selectedItems.add(index);
        completeInvoiceTabController.selectedIdList.add(id);
        completeInvoiceTabController.isAllSelected = completeInvoiceTabController.selectedItems.length == filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (completeInvoiceTabController.isAllSelected) {
        ...
        completeInvoiceTabController.selectedItems = List.generate(filteredItems.length, (index) => index);
        completeInvoiceTabController.selectedIdList = List.generate(filteredItems.length, (id) => id.toString());
      }
      completeInvoiceTabController.isAllSelected = !completeInvoiceTabController.isAllSelected;
    });
  }

  void deleteSelectedItems() {
    setState(() {
      completeInvoiceTabController.deleteData(completeInvoiceTabController.selectedIdList);
      callMethod();
      completeInvoiceTabController.selectedItems.clear();
      completeInvoiceTabController.selectedIdList.clear();
      completeInvoiceTabController.isSelectionMode = false;
  ...
  void downloadSelectedItems() {
    setState(() {
      completeInvoiceTabController.downloadData(completeInvoiceTabController.selectedIdList);
      callMethod();
      completeInvoiceTabController.selectedItems.clear();
      completeInvoiceTabController.selectedIdList.clear();
      completeInvoiceTabController.isSelectionMode = false;
  ...
  void verifySelectedItems() {
    setState(() {
      completeInvoiceTabController.verifyData(completeInvoiceTabController.selectedIdList);
      callMethod();
      completeInvoiceTabController.selectedItems.clear();
      completeInvoiceTabController.selectedIdList.clear();
      completeInvoiceTabController.isSelectionMode = false;
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () => completeInvoiceTabController
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text("${completeInvoiceTabController.selectedItems.length} items selected"),
                                        ],
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Checkbox(
                                              ...
                                              value: completeInvoiceTabController.isAllSelected,
                                        ...
                                        child: ElevatedButton.icon(
                                          onPressed: () => {
                                            GeneralMethods.showPopup(
                                                context,
                                                "verify ${completeInvoiceTabController.selectedItems.length}",
                                      ...
                                      Expanded(
                                        child: ElevatedButton.icon(
                                          onPressed: () => {
                                            GeneralMethods.showPopup(
                                                context,
                                                "delete ${completeInvoiceTabController.selectedItems.length}",
  ...
  Widget listTransactionCard(
    ...
    final isSelected = completeInvoiceTabController.selectedItems.contains(index);
    return InkWell(
      onLongPress: () {
