...
class InvoiceCancelledTab extends StatefulWidget {
  const InvoiceCancelledTab({super.key});

  @override
  State<InvoiceCancelledTab> createState() => _InvoiceCancelledTabState();
}

class _InvoiceCancelledTabState extends State<InvoiceCancelledTab> {
  TextEditingController searchController = TextEditingController();
  var cancelInvoiceTabController = Get.find<CancelInvoiceController>();
  ...
  void callMethod() async {
    await cancelInvoiceTabController.getAllInvoiceData(
      ...
      cancelInvoiceTabController.startDate.value,
      cancelInvoiceTabController.endDate.value,
      "$sortMap",
    );
