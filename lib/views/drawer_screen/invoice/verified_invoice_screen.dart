...
class InvoiceVerifiedTab extends StatefulWidget {
  const InvoiceVerifiedTab({super.key});
  @override
  State<InvoiceVerifiedTab> createState() => _InvoiceVerifiedTabState();
}

class _InvoiceVerifiedTabState extends State<InvoiceVerifiedTab> {
  TextEditingController searchController = TextEditingController();
  var verifiedInvoiceTabController = Get.find<VerifiedInvoiceController>();
  ...
  void callMethod() async{
    await verifiedInvoiceTabController.getAllInvoiceData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      verifiedInvoiceTabController.startDate.value,
      verifiedInvoiceTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = verifiedInvoiceTabController.verifiedInvoiceList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      verifiedInvoiceTabController.verifiedInvoiceList.removeWhere(
              (transaction) => selectedItems.contains(verifiedInvoiceTabController
              .verifiedInvoiceList
              .indexOf(transaction)));
      selectedItems.clear();
      isSelectionMode = false;
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () => verifiedInvoiceTabController
                    ...
                    Card(
                      ...
                      child: Column(
                        children: [
                          ...
                          Obx(() {
                            if (verifiedInvoiceTabController
                                .verifiedInvoiceList.isEmpty) {
