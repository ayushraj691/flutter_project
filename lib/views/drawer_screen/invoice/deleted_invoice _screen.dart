...
class InvoiceDeletedTab extends StatefulWidget {
  const InvoiceDeletedTab({super.key});

  @override
  State<InvoiceDeletedTab> createState() => _InvoiceDeletedTabState();
}

class _InvoiceDeletedTabState extends State<InvoiceDeletedTab> {
  TextEditingController searchController = TextEditingController();
  var deleteInvoiceTabController = Get.find<DeleteInvoiceController>();
  ...
  void CallMethod() async{
    await deleteInvoiceTabController.getAllInvoiceData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      deleteInvoiceTabController.startDate.value,
      deleteInvoiceTabController.endDate.value,
      "$sortMap",
    );
    filteredItems = deleteInvoiceTabController.deleteInvoiceList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      deleteInvoiceTabController.deleteInvoiceList.removeWhere(
              (transaction) => selectedItems.contains(deleteInvoiceTabController
              .deleteInvoiceList
              .indexOf(transaction)));
      selectedItems.clear();
      isSelectionMode = false;
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () => deleteInvoiceTabController
                    ...
                    Card(
                      ...
                      child: Column(
                        children: [
                          ...
                          Obx(() {
                            if (deleteInvoiceTabController
                                .deleteInvoiceList.isEmpty) {
