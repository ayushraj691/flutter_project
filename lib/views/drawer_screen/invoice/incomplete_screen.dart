...
class InvoiceIncompleteTab extends StatefulWidget {
  const InvoiceIncompleteTab({super.key});
  @override
  State<InvoiceIncompleteTab> createState() => _InvoiceIncompleteTabState();
}

class _InvoiceIncompleteTabState extends State<InvoiceIncompleteTab> {
  TextEditingController searchController = TextEditingController();
  var incompleteInvoiceTabController = Get.find<IncompleteInvoiceController>();
  ...
  void callMethod() async{
    await incompleteInvoiceTabController.getAllInvoiceData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      incompleteInvoiceTabController.startDate.value,
      incompleteInvoiceTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = incompleteInvoiceTabController.incompleteInvoiceList;
  }
  ...
  void toggleSelectionMode(int index,String id) {
    setState(() {
      if (incompleteInvoiceTabController.isSelectionMode) {
        if (incompleteInvoiceTabController.selectedItems.contains(index)) {
          incompleteInvoiceTabController.selectedItems.remove(index);
          incompleteInvoiceTabController.selectedIdList.remove(id);
        } else {
          incompleteInvoiceTabController.selectedItems.add(index);
          incompleteInvoiceTabController.selectedIdList.add(id);
        }
        if (incompleteInvoiceTabController.selectedItems.length == filteredItems.length) {
          incompleteInvoiceTabController.isAllSelected = true;
        } else {
          incompleteInvoiceTabController.isAllSelected = false;
        }
        if (incompleteInvoiceTabController.selectedItems.isEmpty) {
          incompleteInvoiceTabController.isSelectionMode = false;
        }
      } else {
        incompleteInvoiceTabController.isSelectionMode = true;
        incompleteInvoiceTabController.selectedItems.add(index);
        incompleteInvoiceTabController.selectedIdList.add(id);
        incompleteInvoiceTabController.isAllSelected = incompleteInvoiceTabController.selectedItems.length == filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (incompleteInvoiceTabController.isAllSelected) {
        incompleteInvoiceTabController. selectedItems.clear();
        incompleteInvoiceTabController.selectedIdList.clear();
      } else {
        incompleteInvoiceTabController.selectedItems = List.generate(filteredItems.length, (index) => index);
        incompleteInvoiceTabController.selectedIdList = List.generate(filteredItems.length, (id) => id.toString());
      }
      incompleteInvoiceTabController.isAllSelected = !incompleteInvoiceTabController.isAllSelected;
    });
  }

  void deleteSelectedItems() {
    setState(() {
      incompleteInvoiceTabController.deleteData(incompleteInvoiceTabController.selectedIdList);
      callMethod();
      incompleteInvoiceTabController.selectedItems.clear();
      incompleteInvoiceTabController.selectedIdList.clear();
      incompleteInvoiceTabController.isSelectionMode = false;
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () => incompleteInvoiceTabController
                              ...
                              child: Row(
                                ...
                                children: [
                                  Obx(() {
                                    return Text(
                                      incompleteInvoiceTabController
                                          .buttonText.value,
                    ...
                    Card(
                      ...
                      child: Column(
                        children: [
                                ...
                                children: [
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text("${incompleteInvoiceTabController.selectedItems.length} items selected"),
                                        ],
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Checkbox(
                                              ...
                                              value: incompleteInvoiceTabController.isAllSelected,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      //           context,
                                      //           "verify ${incompleteInvoiceTabController.selectedItems.length}",
                                      ...
                                      Expanded(
                                        child: ElevatedButton.icon(
                                          onPressed: () => {
                                            GeneralMethods.showPopup(
                                                context,
                                                "delete ${incompleteInvoiceTabController.selectedItems.length}",
                          ...
                          Obx(() {
                            if (incompleteInvoiceTabController
                                .incompleteInvoiceList.isEmpty) {
  ...
  Widget listTransactionCard(
    ...
    final isSelected = incompleteInvoiceTabController.selectedItems.contains(index);
