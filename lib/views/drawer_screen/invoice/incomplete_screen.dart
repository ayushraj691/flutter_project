...
class _InvoiceIncompleteTabState extends State<InvoiceIncompleteTab> {
  ...
  void toggleSelectionMode(int index, String id) {
    setState(() {
      if (incompleteInvoiceTabController.isSelectionMode) {
        ...
        if (incompleteInvoiceTabController.selectedItems.length ==
        ...
        incompleteInvoiceTabController.selectedItems.add(index);
        incompleteInvoiceTabController.selectedIdList.add(id);
        incompleteInvoiceTabController.isAllSelected =
            incompleteInvoiceTabController.selectedItems.length ==
                filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (incompleteInvoiceTabController.isAllSelected) {
        ...
        incompleteInvoiceTabController.selectedItems =
            List.generate(filteredItems.length, (index) => index);
        incompleteInvoiceTabController.selectedIdList =
  ...
  void deleteSelectedItems() {
    setState(() {
      incompleteInvoiceTabController.deleteData(
          incompleteInvoiceTabController.selectedIdList);
      callMethod();
      incompleteInvoiceTabController.selectedItems.clear();
      incompleteInvoiceTabController.selectedIdList.clear();
                                            ...
                                            child: Row(
                                              children: [
                                                Checkbox(
                                                  ...
                                                  value: incompleteInvoiceTabController
                                                      .isAllSelected,
                                            ...
                                            child: ElevatedButton.icon(
                                              onPressed: () =>
                                              {
                                                GeneralMethods.showPopup(
                                                    context,
                                                    "delete ${incompleteInvoiceTabController
  ...
  Widget listTransactionCard(List<ResTransactionDetail> allRecentTransaction,
    ...
    final isSelected = incompleteInvoiceTabController.selectedItems.contains(
        index);
