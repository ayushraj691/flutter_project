...
class VirtualTerminalDownloadedTab extends StatefulWidget {
  ...
  @override
  State<VirtualTerminalDownloadedTab> createState() =>
      _VirtualTerminalDownloadedTabState();
}

class _VirtualTerminalDownloadedTabState
    extends State<VirtualTerminalDownloadedTab> {
  TextEditingController searchController = TextEditingController();
  var downloadVirtualTerminalTabController = Get.find<
      DownloadVirtualTerminalController>();
  var variableController = Get.find<VariableController>();
  List<ResTransactionDetail> filteredItems = <ResTransactionDetail>[].obs;

  @override
  void dispose() {
    downloadVirtualTerminalTabController
        .selectedItems.clear();
    downloadVirtualTerminalTabController
  ...
  void callMethod() async {
    ...
    filteredItems =
        downloadVirtualTerminalTabController.downloadVirtualTerminalList;
  }
  ...
  void toggleSelectionMode(int index, String id) {
    setState(() {
      if (downloadVirtualTerminalTabController.isSelectionMode) {
        if (downloadVirtualTerminalTabController.selectedItems.contains(
            index)) {
        ...
        if (downloadVirtualTerminalTabController.selectedItems.length ==
        ...
        downloadVirtualTerminalTabController.selectedItems.add(index);
        downloadVirtualTerminalTabController.selectedIdList.add(id);
        downloadVirtualTerminalTabController.isAllSelected =
            downloadVirtualTerminalTabController.selectedItems.length ==
                filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (downloadVirtualTerminalTabController.isAllSelected) {
        ...
        downloadVirtualTerminalTabController.selectedItems =
            List.generate(filteredItems.length, (index) => index);
        downloadVirtualTerminalTabController.selectedIdList =
  ...
  void cancelSelectedItems() {
    setState(() {
      downloadVirtualTerminalTabController.cancelData(
          downloadVirtualTerminalTabController.selectedIdList);
      callMethod();
      downloadVirtualTerminalTabController.selectedItems.clear();
      downloadVirtualTerminalTabController.selectedIdList.clear();
  ...
  void downloadSelectedItems() {
    setState(() {
      downloadVirtualTerminalTabController.downloadData(
          downloadVirtualTerminalTabController.selectedIdList);
      callMethod();
      downloadVirtualTerminalTabController.selectedItems.clear();
      downloadVirtualTerminalTabController.selectedIdList.clear();
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              await downloadVirtualTerminalTabController
                                  .downloadCSV();
                            },
                            style: ElevatedButton.styleFrom(
                ...
                Card(
                  ...
                  child: Column(
                    children: [
                                    ...
                                    child: Row(
                                      children: [
                                        Checkbox(
                                          ...
                                          value: downloadVirtualTerminalTabController
                                              .isAllSelected,
                                    ...
                                    child: ElevatedButton.icon(
                                      onPressed: () =>
                                      {
                                        GeneralMethods.showPopup(
                                            context,
                                            "Cancel ${downloadVirtualTerminalTabController
                      ...
                      Obx(() {
                        if (downloadVirtualTerminalTabController
                            .downloadVirtualTerminalList.isEmpty) {
  ...
  Widget listTransactionCard(List<ResTransactionDetail> allRecentTransaction,
    ...
    final isSelected = downloadVirtualTerminalTabController.selectedItems
        .contains(index);
