...
class VirtualTerminalVerifiedTab extends StatefulWidget {
  ...
  @override
  State<VirtualTerminalVerifiedTab> createState() => _VirtualTerminalVerifiedTabState();
}

class _VirtualTerminalVerifiedTabState extends State<VirtualTerminalVerifiedTab> {
  TextEditingController searchController = TextEditingController();
  var verifiedVirtualTerminalTabController = Get.find<VerifiedVirtualTerminalController>();
  ...
  void callMethod() async{
    ...
    filteredItems = verifiedVirtualTerminalTabController.verifiedVirtualTerminalList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      verifiedVirtualTerminalTabController.verifiedVirtualTerminalList.removeWhere(
              (transaction) => selectedItems.contains(verifiedVirtualTerminalTabController
      ...
      body: RefreshIndicator(
        ...
        child: Column(
          children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () => verifiedVirtualTerminalTabController
                          .showSelectDurationBottomSheet(context),
                      child: Obx(() {
                        return Text(
                          verifiedVirtualTerminalTabController.buttonText.value,
                          style:  TextStyle(
                            fontSize: 10,
                            color: Colors.black,
            ...
            Expanded(
              child: Obx(() {
                if (verifiedVirtualTerminalTabController.verifiedVirtualTerminalList.isEmpty) {
