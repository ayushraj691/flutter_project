...
class VirtualTerminalReimbursementTab extends StatefulWidget {
  const VirtualTerminalReimbursementTab({super.key});

  @override
  State<VirtualTerminalReimbursementTab> createState() =>
      _VirtualTerminalReimbursementTabState();
}

class _VirtualTerminalReimbursementTabState
    extends State<VirtualTerminalReimbursementTab> {
  TextEditingController searchController = TextEditingController();
  var reimbursementVirtualTerminalTabController =
      Get.find<ReimbursementVirtualTerminalController>();
  ...
  void callMethod() async{
    await reimbursementVirtualTerminalTabController.getReimbursementVirtualTerminalData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      reimbursementVirtualTerminalTabController.startDate.value,
      reimbursementVirtualTerminalTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = reimbursementVirtualTerminalTabController.reimbursementVirtualTerminalList;
  }

  void _filterItems() {
    String query = searchController.text.toLowerCase();
    setState(() {
      filteredItems = reimbursementVirtualTerminalTabController
          .reimbursementVirtualTerminalList
  ...
  void deleteSelectedItems() {
    setState(() {
      reimbursementVirtualTerminalTabController.reimbursementVirtualTerminalList
          .removeWhere((transaction) => selectedItems.contains(
              reimbursementVirtualTerminalTabController.reimbursementVirtualTerminalList
                  .indexOf(transaction)));
      selectedItems.clear();
      isSelectionMode = false;
      ...
      body: RefreshIndicator(
        ...
        child: Column(
          children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () => reimbursementVirtualTerminalTabController
                          .showSelectDurationBottomSheet(context),
                      child: Obx(() {
                        return Text(
                          reimbursementVirtualTerminalTabController.buttonText.value,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () async {
                            await reimbursementVirtualTerminalTabController.downloadCSV();
                          },
            ...
            Expanded(
              child: Obx(() {
                if (reimbursementVirtualTerminalTabController
                    .reimbursementVirtualTerminalList.isEmpty) {
