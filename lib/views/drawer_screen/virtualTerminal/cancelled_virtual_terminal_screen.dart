...
class VirtualTerminalCancelledTab extends StatefulWidget {
  ...
  @override
  State<VirtualTerminalCancelledTab> createState() =>
      _VirtualTerminalCancelledTabState();
}

class _VirtualTerminalCancelledTabState
    extends State<VirtualTerminalCancelledTab> {
  TextEditingController searchController = TextEditingController();
  var cancelVirtualTerminalTabController = Get.find<
      CancelVirtualTerminalController>();
  ...
  void callMethod() async {
    ...
    filteredItems =
        cancelVirtualTerminalTabController.cancelVirtualTerminalList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      cancelVirtualTerminalTabController.cancelVirtualTerminalList.removeWhere(
              (transaction) =>
              selectedItems.contains(cancelVirtualTerminalTabController
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () =>
                          cancelVirtualTerminalTabController
                      ...
                      child: Row(
                        ...
                        children: [
                          Obx(() {
                            return Text(
                              cancelVirtualTerminalTabController.buttonText
                                  .value,
                ...
                Expanded(
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          await cancelVirtualTerminalTabController
                              .downloadCSV();
                        },
                        style: ElevatedButton.styleFrom(
            ...
            Card(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() {
                    if (cancelVirtualTerminalTabController
                        .cancelVirtualTerminalList.isEmpty) {
