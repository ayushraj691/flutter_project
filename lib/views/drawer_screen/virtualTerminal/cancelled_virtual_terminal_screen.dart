...
class VirtualTerminalCancelledTab extends StatefulWidget {
  const VirtualTerminalCancelledTab({super.key});

  @override
  State<VirtualTerminalCancelledTab> createState() => _VirtualTerminalCancelledTabState();
}

class _VirtualTerminalCancelledTabState extends State<VirtualTerminalCancelledTab> {
  TextEditingController searchController = TextEditingController();
  var cancelVirtualTerminalTabController = Get.find<CancelVirtualTerminalController>();
  ...
  void callMethod() async{
    await cancelVirtualTerminalTabController.getAllCancelVirtualTerminalData(
      CommonVariable.businessId.value,
      '',
      jsonEncode(argumentMap),
      cancelVirtualTerminalTabController.startDate.value,
      cancelVirtualTerminalTabController.endDate.value,
      "$sortMap",
    );

    filteredItems = cancelVirtualTerminalTabController.cancelVirtualTerminalList;
  }
  void _filterItems() {
  ...
  void deleteSelectedItems() {
    setState(() {
      cancelVirtualTerminalTabController.cancelVirtualTerminalList.removeWhere(
              (transaction) => selectedItems.contains(cancelVirtualTerminalTabController
              .cancelVirtualTerminalList
              .indexOf(transaction)));
      selectedItems.clear();
      isSelectionMode = false;
      isAllSelected = false;
      ...
      body: RefreshIndicator(
        ...
        child: Column(
          children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () => cancelVirtualTerminalTabController
                          .showSelectDurationBottomSheet(context),
                      child: Obx(() {
                        return Text(
                          cancelVirtualTerminalTabController.buttonText.value,
                ...
                Expanded(
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          await cancelVirtualTerminalTabController.downloadCSV();
                        },
                        style: ElevatedButton.styleFrom(
            ...
            Expanded(
              child: Obx(() {
                if (cancelVirtualTerminalTabController.cancelVirtualTerminalList.isEmpty) {
