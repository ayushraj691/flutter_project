...
class _VirtualTerminalNewTabState extends State<VirtualTerminalNewTab> {
  ...
  var newVirtualTerminalTabController = Get.find<
  ...
  void toggleSelectionMode(int index, String id) {
    setState(() {
      if (newVirtualTerminalTabController.isSelectionMode) {
        ...
        if (newVirtualTerminalTabController.selectedItems.length ==
        ...
        newVirtualTerminalTabController.selectedItems.add(index);
        newVirtualTerminalTabController.selectedIdList.add(id);
        newVirtualTerminalTabController.isAllSelected =
            newVirtualTerminalTabController.selectedItems.length ==
                filteredItems.length;
      }
    });
  }
  ...
  void toggleSelectAll() {
    setState(() {
      if (newVirtualTerminalTabController.isAllSelected) {
        ...
        newVirtualTerminalTabController.selectedItems =
            List.generate(filteredItems.length, (index) => index);
        newVirtualTerminalTabController.selectedIdList =
  ...
  void deleteSelectedItems() {
    setState(() {
      newVirtualTerminalTabController.deleteData(
          newVirtualTerminalTabController.selectedIdList);
      callMethod();
      newVirtualTerminalTabController.selectedItems.clear();
      newVirtualTerminalTabController.selectedIdList.clear();
  ...
  void downloadSelectedItems() {
    setState(() {
      newVirtualTerminalTabController.downloadData(
          newVirtualTerminalTabController.selectedIdList);
      callMethod();
      newVirtualTerminalTabController.selectedItems.clear();
      newVirtualTerminalTabController.selectedIdList.clear();
  ...
  void verifySelectedItems() {
    setState(() {
      newVirtualTerminalTabController.verifyData(
          newVirtualTerminalTabController.selectedIdList);
      callMethod();
      newVirtualTerminalTabController.selectedItems.clear();
      newVirtualTerminalTabController.selectedIdList.clear();
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () =>
                                      newVirtualTerminalTabController
                                          .showSelectDurationBottomSheet(
                                          context),
                                  child: Obx(() {
                                    return Text(
                                      newVirtualTerminalTabController.buttonText
                                          .value,
                            ...
                            Expanded(
                              child: Align(
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      await newVirtualTerminalTabController
                                          .downloadCSV();
                                    },
                                    style: ElevatedButton.styleFrom(
                        ...
                        Card(
                          ...
                          child: Column(
                            children: [
                              ...
                              if (newVirtualTerminalTabController
                                  .isSelectionMode)
                                Container(
                                  padding: const EdgeInsets.symmetric(
                                            ...
                                            child: Row(
                                              children: [
                                                Checkbox(
                                                  ...
                                                  value: newVirtualTerminalTabController
                                                      .isAllSelected,
                                                  activeColor:
                                            ...
                                            child: ElevatedButton.icon(
                                              onPressed: () =>
                                              {
                                                GeneralMethods.showPopup(
                                                    context,
                                                    "verify ${newVirtualTerminalTabController
                                          ...
                                          Expanded(
                                            child: ElevatedButton.icon(
                                              onPressed: () =>
                                              {
                                                GeneralMethods.showPopup(
                                                    context,
                                                    "delete ${newVirtualTerminalTabController
                                                        .selectedItems.length}",
                              ...
                              Obx(() {
                                if (newVirtualTerminalTabController
                                    .newVirtualTerminalList.isEmpty) {
  ...
  Widget listTransactionCard(List<ResTransactionDetail> allRecentTransaction,
    ...
    final isSelected = newVirtualTerminalTabController.selectedItems.contains(
        index);
    return InkWell(
      onLongPress: () {
