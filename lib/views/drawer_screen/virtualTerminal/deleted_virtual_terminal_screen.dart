...
class VirtualTerminalDeletedTab extends StatefulWidget {
  ...
  @override
  State<VirtualTerminalDeletedTab> createState() => _VirtualTerminalDeletedTabState();
}

class _VirtualTerminalDeletedTabState extends State<VirtualTerminalDeletedTab> {
  TextEditingController searchController = TextEditingController();
  var deleteVirtualTerminalTabController = Get.find<DeleteVirtualTerminalController>();
  ...
  void callMethod() async{
    ...
    filteredItems = deleteVirtualTerminalTabController.deleteVirtualTerminalList;
  }
  ...
  void deleteSelectedItems() {
    setState(() {
      deleteVirtualTerminalTabController.deleteVirtualTerminalList.removeWhere(
              (transaction) => selectedItems.contains(deleteVirtualTerminalTabController
      ...
      body: RefreshIndicator(onRefresh: _refreshData,
        child: Column(
          children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () => deleteVirtualTerminalTabController
                          .showSelectDurationBottomSheet(context),
                      child: Obx(() {
                        return Text(
                          deleteVirtualTerminalTabController.buttonText.value,
                ...
                Expanded(
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          await deleteVirtualTerminalTabController.downloadCSV();
                        },
                        style: ElevatedButton.styleFrom(
            ...
            Expanded(
              child: Obx(() {
                if (deleteVirtualTerminalTabController.deleteVirtualTerminalList.isEmpty) {
