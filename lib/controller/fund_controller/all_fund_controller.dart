...
class AllFundsController extends GetxController {
  var variableController = Get.find<VariableController>();
  List<ResFundsDetails> allFundsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in allFundsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/allFunds.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the allFunds CSV file.',
  ...
  getAllFundsData(
    ...
    try {
      ...
      if (res != null) {
        ...
        allFundsList.addAll(fundsList);

        if (allFundsList.isEmpty) {
          // MyToast.toast("No Funds found.");
        }
      } else {
