...
class SuccessfulFundsController extends GetxController {
  var variableController = Get.find<VariableController>();
  List<ResFundsDetails> successfulFundsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in successfulFundsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/successfulFunds.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the successfulFunds CSV file.',
  ...
  getSuccessfulFundsData(
    ...
    try {
      ...
      if (res != null) {
        ...
        successfulFundsList.addAll(fundsList);

        if (successfulFundsList.isEmpty) {
