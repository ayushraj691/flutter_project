...
class PendingFundsController extends GetxController {
  var variableController = Get.find<VariableController>();
  List<ResFundsDetails> pendingFundsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in pendingFundsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/pendingFunds.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the pendingFunds CSV file.',
  ...
  getPendingFundsData(
    ...
    try {
      ...
      if (res != null) {
        ...
        pendingFundsList.addAll(fundsList);

        if (pendingFundsList.isEmpty) {
