...
class CancelSubscriptionsController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> cancelSubscriptionsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in cancelSubscriptionsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/cancelSubscription.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the cancelSubscription CSV file.',
  ...
  getAllSubscriptionsData(
    ...
    try {
      ...
      if (res != null) {
        ...
        cancelSubscriptionsList.addAll(customerList);

        if (cancelSubscriptionsList.isEmpty) {
