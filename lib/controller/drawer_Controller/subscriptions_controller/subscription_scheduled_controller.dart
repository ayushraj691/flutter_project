...
class ScheduledSubscriptionsController extends GetxController {
  var variableController = Get.find<VariableController>();
  List<ResTransactionDetail> scheduledSubscriptionsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in scheduledSubscriptionsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath =
              "${downloadsDirectory.path}/scheduledSubscriptions.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the scheduledSubscriptions CSV file.',
  ...
  getAllSubscriptionsData(
    ...
    try {
      scheduledSubscriptionsList.clear();
      ...
      if (res != null) {
        ...
        scheduledSubscriptionsList.addAll(customerList);

        if (scheduledSubscriptionsList.isEmpty) {
