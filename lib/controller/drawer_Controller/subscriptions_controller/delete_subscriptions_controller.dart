...
class DeleteSubscriptionsController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> deleteSubscriptionsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in deleteSubscriptionsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/deleteSubscription.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the deleteSubscription CSV file.',
  ...
  getAllSubscriptionsData(
    ...
    try {
      ...
      if (res != null) {
        ...
        deleteSubscriptionsList.addAll(customerList);

        if (deleteSubscriptionsList.isEmpty) {
