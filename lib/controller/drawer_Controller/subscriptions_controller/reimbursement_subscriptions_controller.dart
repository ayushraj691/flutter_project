...
class ReimbursementSubscriptionsController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> reimbursementSubscriptionsList =
  ...
  ReimbursementSubscriptionsController() {
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in reimbursementSubscriptionsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath =
              "${downloadsDirectory.path}/reimbursementSubscription.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the reimbursementSubscription CSV file.',
  ...
  getAllSubscriptionsData(
    ...
    try {
      reimbursementSubscriptionsList.clear();
      ...
      if (res != null) {
        ...
        reimbursementSubscriptionsList.addAll(customerList);

        if (reimbursementSubscriptionsList.isEmpty) {
