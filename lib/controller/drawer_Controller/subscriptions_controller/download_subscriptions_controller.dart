...
class DownloadSubscriptionsController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> downloadSubscriptionsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in downloadSubscriptionsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath =
              "${downloadsDirectory.path}/downloadSubscription.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the downloadSubscription CSV file.',
  ...
  getAllSubscriptionsData(
    ...
    try {
      downloadSubscriptionsList.clear();
      ...
      if (res != null) {
        ...
        downloadSubscriptionsList.addAll(customerList);

        if (downloadSubscriptionsList.isEmpty) {
