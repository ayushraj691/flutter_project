...
class VerifiedSubscriptionsController extends GetxController {
  var variableController = Get.find<VariableController>();
  List<ResTransactionDetail> verifiedSubscriptionsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in verifiedSubscriptionsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath =
              "${downloadsDirectory.path}/verifiedSubscriptions.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the verifiedSubscriptions CSV file.',
  ...
  getAllSubscriptionsData(
    ...
    try {
      verifiedSubscriptionsList.clear();
      ...
      if (res != null) {
        ...
        verifiedSubscriptionsList.addAll(customerList);

        if (verifiedSubscriptionsList.isEmpty) {
