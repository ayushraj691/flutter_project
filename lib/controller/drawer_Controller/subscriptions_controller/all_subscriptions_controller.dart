...
class AllSubscriptionsController extends GetxController {
  ...
  List<ResTransactionDetail> allSubscriptionsList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in allSubscriptionsList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/allSubscription.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the allSubscription CSV file.',
  ...
  getAllSubscriptionsData(
    ...
    try {
      ...
      if (res != null) {
        ...
        allSubscriptionsList.addAll(customerList);
        if (allSubscriptionsList.isEmpty) {
