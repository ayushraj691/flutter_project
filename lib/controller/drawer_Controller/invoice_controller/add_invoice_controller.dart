...
import 'package:paycron/model/drawer_model/create_payment_model/ReqInvoicePayment.dart';
...
class AddInvoiceController extends GetxController {
  ...
  insertInvoicePaymentData() async {
    ...
    ReqInvoicePayment reqInvoicePayment = ReqInvoicePayment(
        custId: customerId,
        bankId: bankId,
        payDue: paymentDueController.value.text,
