...
class CompleteInvoiceController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> completeInvoiceList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in completeInvoiceList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/completeInvoice.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the completeInvoice CSV file.',
  ...
  getAllInvoiceData(
    ...
    try {
      ...
      if (res != null) {
        ...
        completeInvoiceList.addAll(customerList);

        if (completeInvoiceList.isEmpty) {
