...
class DeleteInvoiceController extends GetxController {
  ...
  List<ResTransactionDetail> deleteInvoiceList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in deleteInvoiceList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/deleteInvoice.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the deleteInvoice CSV file.',
  ...
  getAllInvoiceData(
    ...
    try {
      ...
      if (res != null) {
        ...
        deleteInvoiceList.addAll(customerList);

        if (deleteInvoiceList.isEmpty) {
