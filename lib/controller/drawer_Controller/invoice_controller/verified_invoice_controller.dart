...
class VerifiedInvoiceController extends GetxController {
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in verifiedInvoiceList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/verifyInvoice.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the verifyInvoice CSV file.',
