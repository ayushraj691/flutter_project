...
class ReimbursementInvoiceController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> reimbursementInvoiceList =
  ...
  ReimbursementInvoiceController() {
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in reimbursementInvoiceList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath =
              "${downloadsDirectory.path}/reimbursementInvoice.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the reimbursementInvoice CSV file.',
  ...
  getAllInvoiceData(
    ...
    try {
      reimbursementInvoiceList.clear();
      ...
      if (res != null) {
        ...
        reimbursementInvoiceList.addAll(customerList);

        if (reimbursementInvoiceList.isEmpty) {
