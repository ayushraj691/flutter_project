...
class InActiveProductController extends GetxController {
    ...
    try {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          ...
          final filePath = "${downloadsDirectory.path}/inactiveProduct.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the inactiveProduct CSV file.',
