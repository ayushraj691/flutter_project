...
class ReimbursementTransactionController extends GetxController {

  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> reimbursementTransactionList =
  ...
  ReimbursementTransactionController() {
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in reimbursementTransactionList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory
              .path}/reimbursementTransaction.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the reimbursementTransaction CSV file.',
  ...
  getAllTransactionData(String businessId,
      String query,
      String argument,
      String startDate,
      String endDate,
    ...
    try {
      reimbursementTransactionList.clear();
      ...
      if (res != null) {
        ...
        reimbursementTransactionList.addAll(customerList);

        if (reimbursementTransactionList.isEmpty) {
