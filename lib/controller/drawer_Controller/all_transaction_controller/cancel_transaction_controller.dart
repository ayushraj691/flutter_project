...
class CancelTransationController extends GetxController {
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in cancelTransactionList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/cancelTransaction.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the cancelTransaction CSV file.',
