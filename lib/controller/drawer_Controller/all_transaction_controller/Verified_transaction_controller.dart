...
class VerifiedTransactionController extends GetxController {
  var variableController = Get.find<VariableController>();
  List<ResTransactionDetail> verifiedTransactionList =
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in verifiedTransactionList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/verifyTransaction.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the verifyTransaction CSV file.',
  ...
  getAllTransactionData(
    ...
    try {
      ...
      if (res != null) {
        ...
        verifiedTransactionList.addAll(customerList);

        if (verifiedTransactionList.isEmpty) {
