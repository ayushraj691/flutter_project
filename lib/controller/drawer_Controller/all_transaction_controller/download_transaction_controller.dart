...
class DownloadTransactionController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> downloadTransactionList =
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the downloadTransaction CSV file.',
