...
class DownloadVirtualTerminalController extends GetxController {
  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> downloadVirtualTerminalList =
  ...
  void callMethod() async {
    ...
    await getDownloadVirtualTerminalData(
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in downloadVirtualTerminalList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath =
              "${downloadsDirectory.path}/downloadVirtualTerminal.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the downloadVirtualTerminal CSV file.',
  ...
  getDownloadVirtualTerminalData(
    String businessId,
    String query,
    String argument,
    String startDate,
    ...
    try {
      downloadVirtualTerminalList.clear();
      ...
      if (res != null) {
        ...
        downloadVirtualTerminalList.addAll(customerList);

        if (downloadVirtualTerminalList.isEmpty) {
