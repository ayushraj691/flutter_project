...
class CancelVirtualTerminalController extends GetxController {

  var variableController = Get.find<VariableController>();

  List<ResTransactionDetail> cancelVirtualTerminalList =
  ...
  void callMethod() async {
    ...
    await getAllCancelVirtualTerminalData(
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in cancelVirtualTerminalList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory
              .path}/cancelVirtualTerminal.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the cancelVirtualTerminal CSV file.',
  ...
  getAllCancelVirtualTerminalData(String businessId,
      String query,
      String argument,
      String startDate,
      String endDate,
    ...
    try {
      cancelVirtualTerminalList.clear();
      ...
      if (res != null) {
        ...
        cancelVirtualTerminalList.addAll(customerList);

        if (cancelVirtualTerminalList.isEmpty) {
