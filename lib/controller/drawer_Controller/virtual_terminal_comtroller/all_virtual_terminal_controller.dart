...
class AllVirtualTerminalController extends GetxController {

  var variableController = Get.find<VariableController>();
  List<ResTransactionDetail> allVirtualTerminalList =
  ...
  void callMethod() async {
    ...
    await getAllVirtualTerminalData(
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in allVirtualTerminalList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath = "${downloadsDirectory.path}/AllVirtualTerminal.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the AllVirtualTerminal CSV file.',
  ...
  getAllVirtualTerminalData(String businessId,
      String query,
      String argument,
      String startDate,
      String endDate,
    ...
    try {
      ...
      if (res != null) {
        ...
        allVirtualTerminalList.addAll(customerList);

        if (allVirtualTerminalList.isEmpty) {
