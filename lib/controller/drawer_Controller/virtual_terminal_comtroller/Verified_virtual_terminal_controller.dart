...
class VerifiedVirtualTerminalController extends GetxController {
  var variableController = Get.find<VariableController>();
  List<ResTransactionDetail> verifiedVirtualTerminalList =
  ...
  void callMethod() async {
    ...
    await getVerifiedVirtualTerminalData(
  ...
  Future<void> downloadCSV() async {
    try {
      ...
      for (var transaction in verifiedVirtualTerminalList) {
      ...
      if (status.isGranted) {
        ...
        if (downloadsDirectory != null) {
          final filePath =
              "${downloadsDirectory.path}/verifyVirtualTerminal.csv";
          ...
          await flutterLocalNotificationsPlugin.show(
            0,
            'Download Complete',
            'Tap to open the verifyVirtualTerminal CSV file.',
  ...
  getVerifiedVirtualTerminalData(
    String businessId,
    String query,
    String argument,
    String startDate,
    ...
    try {
      verifiedVirtualTerminalList.clear();
      ...
      if (res != null) {
        ...
        verifiedVirtualTerminalList.addAll(customerList);

        if (verifiedVirtualTerminalList.isEmpty) {
