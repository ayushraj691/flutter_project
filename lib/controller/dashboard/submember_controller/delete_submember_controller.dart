...
class DeleteSubmemberController extends GetxController{
  var variableController = Get.find<VariableController>();

  List<ResAllSubmemberModel> deleteSubmemberList =
  ...
  getDeleteSubmember(
    ...
    try {
      ...
      if (res != null) {
        ...
        deleteSubmemberList.addAll(submemberList);

        if (deleteSubmemberList.isEmpty) {
