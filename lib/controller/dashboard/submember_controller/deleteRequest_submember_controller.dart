...
class DeleteRequestSubmemberController extends GetxController{
  var variableController = Get.find<VariableController>();

  List<ResAllSubmemberModel> deleteRequestSubmemberList =
      List<ResAllSubmemberModel>.empty(growable: true).obs;


  getDeleteRequestSubmember(
      String userId,
      String query,
      String argument,
      String sort,
    ...
    try {
      deleteRequestSubmemberList.clear();
      ...
      if (res != null) {
        ...
        deleteRequestSubmemberList.addAll(submemberList);

        if (deleteRequestSubmemberList.isEmpty) {
